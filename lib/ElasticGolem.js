...
module.exports.prototype.unqiueBodyProperties = Object.keys(this.schemaBody.mappings.posting.properties).filter(
	(field) => {
		return this.schemaBody.mappings.posting.properties[field].hasOwnProperty('analyzer');
	}
);
